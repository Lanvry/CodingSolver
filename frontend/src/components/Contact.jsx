    ...
    <section id="contact" ref={sectionRef} className="contact">
      ...
      <div className="container">
        <div className="contact__inner">
          ...
          {/* Form side */}
          <div ref={formRef} className="contact__form-wrap contact__actions-wrap">
            ...
            <a href="mailto:codingsolver0@gmail.com" className="btn btn--primary contact__action-btn">
            ...
            <a href="https://wa.me/6285730426264" target="_blank" rel="noopener noreferrer" className="btn contact__action-btn contact__action-btn--secondary">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
